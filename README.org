...
See more on Synergia SuperCollider help file

Place the startup file and the Synergia SuperCollider help file (=client_sclang_config= folder) into your SuperCollider Extensions directory
